...
var=tkinter.IntVar()
r1 = tkinter.Radiobutton(t, text="Female", variable=var, value=1,command=display)
r2 = tkinter.Radiobutton(t, text="Male", variable=var, value=2,command=display)

label4=tkinter.Label(t)
